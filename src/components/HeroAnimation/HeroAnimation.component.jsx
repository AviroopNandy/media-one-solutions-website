...
import "./HeroAnimation.style.css";
            ...
            >
              <defs>
                <linearGradient
                  ...
                  y2="15%"
                >
                  <stop stopColor="rgb(39, 187, 219)" offset="0%" />
                  <stop stopColor="#242423" offset="50%" />
                  <stop stopColor="#0D0D0C" offset="100%" />
                </linearGradient>
              </defs>
              {/* <text
                transform="matrix(1 0 0 1 20.5 85)"
                style={{
                  zIndex: "99999999",
                }}
              >
